...
function CarregarDocsAtualizados() {

    var objParametro = {

        
        success: function (data) {
            $('#divDocsAtualizados').html("");
            $('#divDocsAtualizados').html(data);
            $('[data-toggle="tooltip"]').tooltip();
        ...
        beforeSend: function (response) {
            $('#divDocsAtualizados').html(strLoading);
        }
    }
    call_AjaxHtml("POST", actionDocumentosAtualizados, objParametro);

}

function CarregarDocsDownloads() {

    var objParametro = {


        success: function (data) {
            $('#divDocsDownload').html("");
            $('#divDocsDownload').html(data);
            $('[data-toggle="tooltip"]').tooltip();
        ...
        beforeSend: function (response) {
            $('#divDocsDownload').html(strLoading);
        }
    }
    call_AjaxHtml("POST", actionDocumentosDownloads, objParametro);
